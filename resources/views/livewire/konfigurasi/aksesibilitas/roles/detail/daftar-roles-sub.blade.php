                        ...
                        <div class="d-flex justify-content-start align-items-center">
                            ...
                            <div class="d-flex flex-column justify-content-start fw-bold">
                                <a href="{{ route('user-management.users.show', $user) }}"
                                    class="text-gray-800 text-hover-primary mb-1 text-start" wire:navigate>
                                    {{ $user->name }}
                                </a>
    ...
    <script data-navigate-once>
        (function() {
            const PageFunction = function() {
                $('[data-kt-action="delete_row"]').off('click').on('click', function(e) {
                    console.log('delete_row_role_sub');
                    e.preventDefault();
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            Livewire.dispatch('aksesibilitas.roles.detail.delete', [id]);
